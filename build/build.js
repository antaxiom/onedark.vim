...
const baseColors = Object.freeze({
	red: { gui: '#F55555', cterm: '204', cterm16: '1' }, // alternate cterm: 168
	...
	purple: { gui: '#CF4DDD', cterm: '170', cterm16: '5' }, // alternate cterm: 176
	cyan: { gui: '#36C8ED', cterm: '38', cterm16: '6' }, // alternate cterm: 73
	white: { gui: '#CDCDCD', cterm: '145', cterm16: '7' },
	black: { gui: '#111111', cterm: '235', cterm16: '0' },
})

const specialColors = Object.freeze({
	comment_grey: { gui: '#3F3F49', cterm: '59', cterm16: '15' },
	gutter_fg_grey: { gui: '#45454F', cterm: '238', cterm16: '15' },
	cursor_grey: { gui: '#1C1C1C', cterm: '236', cterm16: '8' },
	visual_grey: { gui: '#242424', cterm: '237', cterm16: '15' },
	menu_grey: { cterm16: '8' }, // vim theme handles gui/cterm values
	special_grey: { gui: '#2B2B2B', cterm: '238', cterm16: '15' },
	vertsplit: { gui: '#181818', cterm: '59', cterm16: '15' },
})
